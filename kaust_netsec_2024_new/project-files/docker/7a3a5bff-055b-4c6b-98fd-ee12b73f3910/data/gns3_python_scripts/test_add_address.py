...
ADDRESS_ID = 8 # Any number that is not taken by the other subflows should work
...
def main():
    ...
    print "Sending ADD_ADDR to Server server_ip: {} client_ip: {} portd: {}, ports: {} ".format(SERVER_IP, CLIENT_IP, SERVER_PORT, pktl[0][TCP].sport)
