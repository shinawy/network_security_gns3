...
# Configuration of the machines in the net1.local network
...
# Configuration of the machines in the net2.local network
...
# Configuration of the machines in the net3.local network
...
cp -f /etc/MYBOOT/NGINX/default.conf /etc/nginx/conf.d/default.conf
